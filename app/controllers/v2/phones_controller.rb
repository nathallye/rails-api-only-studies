module V2  
  class PhonesController < ApplicationController
    ...
    def create
      ...
      if @contact.save
        render json: @contact.phones, status: :created, location: v2_contact_phones_url(@contact) # o location vai exibir a url desse elemento no header que vai retornar
      else
