  ...
  class AddressesController < ApplicationController
    ...
    def create
      ...
      if @contact.address.save
        render json: @contact.address, status: :created, location: v1_contact_address_url(@contact) # o location vai exibir a url desse elemento no header que vai retornar
      else
